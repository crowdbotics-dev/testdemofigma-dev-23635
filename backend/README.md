...
## Project Structure
    ...
    ├── testdemofigma_dev_23635  # Django project configurations
...
1. Clone this repo and `cd testdemofigma_dev_23635`
...
2. Clone this repo and `cd testdemofigma_dev_23635`
